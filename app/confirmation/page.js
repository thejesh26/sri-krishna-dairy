    ...
    <div className="min-h-screen bg-[#fdfbf7] flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="bg-white rounded-2xl shadow-lg border border-[#e8e0d0] p-10 w-full max-w-md text-center">
          ...
          {/* WhatsApp activation */}
          <div className="bg-[#f0faf4] border border-[#1a5c38] rounded-xl p-4 mb-6 text-left">
            <p className="text-sm font-bold text-[#1a5c38] mb-1">📱 Activate WhatsApp Notifications</p>
            <p className="text-xs text-gray-600 mb-3 leading-relaxed">
              Save our number and send <strong>'Hi'</strong> to start receiving delivery updates on WhatsApp!
            </p>
            <a
          ...
          <p className="text-sm text-gray-500 mb-6">
            Questions? Call <strong className="text-[#1c1c1c]">8105054473</strong> or email <strong className="text-[#1c1c1c]">hello@srikrishnaadairy.in</strong>
          </p>
